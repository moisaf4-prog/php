...
import { 
  Zap, Target, History, CreditCard, User, Shield, LogOut, Menu, X 
} from "lucide-react";
      ...
      <aside className="hidden lg:flex w-64 flex-col h-screen sticky top-0 border-r border-cyber-border bg-black/95 backdrop-blur z-40">
        ...
        <div className="p-4 border-t border-cyber-border">
          ...
          <Button
            ...
            variant="ghost"
            className="w-full justify-start gap-3 text-cyber-muted hover:text-cyber-secondary hover:bg-cyber-secondary/10"
          >
